                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <label>Tiêu đề top list trang chủ</label>
                                                <input class="form-control" name="site_title_top_list" value="{{!empty($oneItem->site_title_top_list) ? $oneItem->site_title_top_list : ''}}" type="text" placeholder="Tiêu đề top list trang chủ">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="site_keyword" rows="4" placeholder="Từ khóa trang">{{!empty($oneItem->site_keyword) ? $oneItem->site_keyword : ''}}</textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label>Mô tả trang</label>
                                                <textarea rows="4" class="form-control area-tiny-featured" name="site_content">{{!empty($oneItem->site_content) ? $oneItem->site_content : ''}}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Nội dung trang</label>
                                                <textarea id="full-featured" class="form-control" name="site_content_full">{{!empty($oneItem->site_content_full) ? $oneItem->site_content_full : ''}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
