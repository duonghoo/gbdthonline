                    ...
                    <div class="card-body">
                        <form method="get" action="">
                            <div class="form-group row">
                                ...
                                <div class="col-2">
                                    <select name="count_link" class="form-control">
                                        <option value="">Sắp xếp theo số link</option>
                                      
                                            <option value="ASC" {{ !empty($_GET['count_link']) && 'ASC' == $_GET['count_link'] ? 'selected' : '' }}>
                                                Số Link Thấp -> Cao
                                            </option>

                                            <option value="DESC" {{ !empty($_GET['count_link']) && 'DESC' == $_GET['count_link'] ? 'selected' : '' }}>
                                                Số Link Cao -> Thấp
                                            </option>
...
{{--                                    <p><span class="font-weight-bold">{{$item->count_link_out}}</span></p>--}}
                                    <p class="mb-0"><span class="font-weight-bold">{{$item->count_link_out}}</span></p>
                                </td>
                                <td class="text-center align-middle">{{ !empty($item->category_id) ? $categoryTree[$item->category_id]['sub_title'] : '' }}</td>
