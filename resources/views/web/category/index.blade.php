        ...
        <div class="d-flex flex-wrap">
            ...
            <div class="col-12 col-lg-12 px-0">
                ...
                @if(!empty($top_game->toArray()))
                    {{-- @php dd($top_game) @endphp --}}
                    {!! viewGameBai($top_game) !!}
                @endif

                <section class="mt-3 mb-5 w-100 post-content">
                    {!! $oneItem->content !!}
                </section>
                @php
                ...
                @include('web.block._list_post_cate',$post_cate) 
                        ...
                        @foreach($post as $value)
                            <article class="col-12 d-flex mb-4">
                                ...
                                <div class="col-9 pl-3 pr-0">
                                    ...
                                    <div class="text-grey4 font-13 d-none d-lg-block max-line-2">{!! !empty($value->description) ? get_limit_content(trim($value->description), 200) : get_limit_content(trim($value->content), 200) !!}</div>
                                </div>
                            </article>
                        @endforeach
                    </section>
