...
<div class="position-fixed top-0 bottom-0 left-0 right-0 text-center" style="background-color: rgba(0,0,0,0.45); z-index: 3;" id="ampPopup">
    <div class="position-relative d-block mx-auto" style="z-index: 2;margin-top: 15vh;max-width: 300px">
        <?=$popup?>
    </div>
    <div class="position-absolute top-0 bottom-0 left-0 right-0" role="button" tabindex="-1" on="tap:adsPopUp.toggleClass(class='d-none')" id="btn-close-ads" style="z-index: 1"></div>
</div>
<?php endif?>
